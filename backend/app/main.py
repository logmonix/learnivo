...
from app.api.v1 import auth, profiles, curriculum, learning, admin, gamification, seed, dev, content_management, images
...
app.include_router(content_management.router, prefix="/api/v1/admin", tags=["content-management"])
